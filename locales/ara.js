export default {
  ...
  why: {
    ...
    content: [
      ...
      '      يهدف هذا الموقع إلى إبراز مهنة الباني المستقل عبر تعريف الجمهور بها. وبمجرد قراءتك لهذه الأسطر، فأنت تساعد آلاف البنائين المستقلين الذين يسعون كل يوم إلى إنشاء أفضل الخدمات على الإنترنت.',
    ],
  },
  ...
  roles: {
    ...
    developmentContent: 'غالبًا ما يطوّر الباني المستقل مشاريعه الخاصة وإن لم يكن خبيرًا في التطوير.',
    designTitle: 'التصميم',
    designContent: 'غالبًا ما يصمّم الباني المستقل مشاريعه الخاصة وإن لم يكن خبيرًا في التصميم.',
    marketingTitle: 'التسويق',
    marketingContent: 'التسويق جزء مهم من عمل الباني المستقل، لتسويق مشاريعه، يحتاج إلى ترويجها وإشهارها',
 ...
 vocabulary: {
    ...
    saas: 'SAAS',
    saasDef: 'بالعربية: البرمجيات كخدمة، وهي برامج مقدم عبر الإنترنت، وغالبًا ما توفر مقابل اشتراك متجدد، ما يسمح لأصحابها بالحصول على دخل دائم ودوري.',
    churn: 'Churn',
